        ...
        <div class="row">
            <div class="box">
                <div class="col-lg-12">
                    ...
                    <hr>
                    <p class="text-center">Web ini digunakan untuk membuat arsip surat atau dokumen yang masuk dan keluar</p>
					<p class="text-center">Disamping itu web ini dibuat agar bisa membantu seorang user untuk menyimpan atau menggunakan kembali data yg akan digunakan</p>
